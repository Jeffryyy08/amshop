...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* Productos */}
      {/* Productos - Recientemente agregadas */}
      <main>
        <h2>🆕 Recientemente agregadas</h2>
        <div className="grid">
          {productos
            .sort((a, b) => b.id - a.id)  // Ordenar por ID descendente (más nuevo primero)
            .slice(0, 3)  // Tomar solo las últimas 3
            .map(prod => (
